<?php 
define('SYSTEM_BASE_URL', 'http://127.0.0.1/brave_src/');
define('SYSTEM_URL_DOWNLOAD', 'https://laptop-updates.brave.com/download/QUC179');
define('SYSTEM_SCRIPT_GOOGLE_ANALYZE', '
